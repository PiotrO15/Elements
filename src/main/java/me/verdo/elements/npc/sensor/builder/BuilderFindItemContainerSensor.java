...
import me.verdo.elements.npc.sensor.FindItemContainerSensor;

import javax.annotation.Nonnull;

public class BuilderFindItemContainerSensor extends BuilderSensorBase {
    ...
    public Sensor build(BuilderSupport builderSupport) {
        return new FindItemContainerSensor(this, builderSupport);
    }
